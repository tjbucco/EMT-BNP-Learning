function [X_initial, cluster_labels, no_of_new_objects, clutterindex, X_kmeans] = cluster_measurements_em_FUSION(measurements, hyper, script, no_of_objects, Cov_extent, Xpredict)
...
if no_of_measurements == 0
    ...
    for k = 1:script.Nbirth + 1
        ...
        lambda = [hyper.ElambdaM * ones(no_of_objects + k - 1, 1); hyper.lambdaclutter];
