...
for ell = 2:mcmc.L
    ...
    if ~mod(ell, mcmc.DPrsi)
        [object_class_est, C, Dstar, Qstar, lambdaMstar, Ccs, Dstarcs, Qstarcs, lambdaMstarcs] = cluster_objects(init_tracking, Xcs, object_class_est, hyper, script.factorials, mcmc, ell, C, Dstar, Qstar, lambdaMstar);
    end
end
