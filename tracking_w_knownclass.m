function [results, OSPA, MSE] = tracking_w_knownclass(data, hyperparams, script_params, mcmc_params, seq_tracking, sim)
...
for j = 1:script_params.J
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    [state_est_mcmc, object_class_est_mcmc] = track_Objects_w_knownParams(seq_tracking, data, hyperparams, script_params, mcmc_params, sim, j);
